...
//   return (
//     <section className="max-w-4xl mx-auto my-8 p-6 bg-indigo-50 rounded-lg shadow-lg space-y-6">
//       <div>
...
//         <Link
//           to={`/edit-job/${job.id}`}
//           className="flex-1 bg-indigo-500 hover:bg-indigo-600 text-white py-2 rounded-lg text-center font-semibold"
//         >
//           Edit Job
//         </Link>
//         <button
...
// Add this named export for the loader
